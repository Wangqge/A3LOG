...
\begin{proof}
	...
	\end{align}
	First we start from the Normal recursive aggregation as line 1.	Line 2 is true because of the monotonic property of F. And line 3 is true because \textcolor{red}{orderindependent} property. Line 4 and 5 can be derived  from monotonic and \textcolor{red}{orderindependent} property. Line 6 is true because of the idempotent property. By repeat applying theseproperties, we can reduce the original formula to line 8, the accumulatied recursive aggregation. 
\end{proof}
