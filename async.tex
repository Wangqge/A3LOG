...
the accumulated recursive converge to the same result with recursive aggregation when executed infinite times.%such that the result is independent of $X$. 
