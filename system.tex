...
... can affect .....
these can all be attributed to \textbf{Message Buffer strategy}

is there need some fig and experiment to show the result.

Based on the message generation speed 
