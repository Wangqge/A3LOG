...
\begin{align}
&G\circ F\circ G(X\cup Y)=G\circ F( G(X)\cup G(Y))\notag\\
&G(F'\circ G(X\cup Y)\cup G(X\cup Y) )\notag\\
&=G(F(G(X)\cup G(Y))\cup G(X)\cup G(Y))\notag\\
&G(G(X\cup Y))=G(G(X)\cup G(Y))\notag\\
&G(F'\circ G(X\cup Y) )=G(F(G(X)\cup G(Y)))\notag
\end{align}
