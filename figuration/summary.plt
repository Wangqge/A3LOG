...
unset grid
unset ylabel
set xlabel "(b) SSSP" font "Times-Roman,40"  
set yrange [0:180]
set ytics 20
set xtics rotate by 340 
set boxwidth 1
...
#set title "PageRank"
unset ylabel
set xlabel "(d) COST" font "Times-Roman,40"  
unset grid
set yrange [0:120]
set ytics 20
set xtics rotate by 340
...
plot for [COL=2:7:1] 'summary_cost.txt' using COL:xticlabels(1)  title columnheader(COL),\
 'summary_cost.txt' u ($0-1-2./7):2:(fn($2)) w labels  rotate by 90 font ",18" offset char -0.5,0.5 t '' , \
 'summary_cost.txt' u ($0-1-1./7):3:(fn($3)) w labels  rotate by 90 font ",18" offset char -0.5,0.5 t '' , \
 'summary_cost.txt' u ($0-1+0./7):4:(fn($4)) w labels  rotate by 90 font ",18" offset char -0.5,0.5 t '' , \
 'summary_cost.txt' u ($0-1+1./7):5:(fn($5)) w labels  rotate by 90 font ",18" offset char -0.5,0.5 t '' , \
 'summary_cost.txt' u ($0-1+2./7):6:(fn($6)) w labels  rotate by 90 font ",18" offset char -0.5,0.5 t '' , \
 'summary_cost.txt' u ($0-1+3./7):7:(fn($7)) w labels  rotate by 90 font ",18" offset char -0.5,0.5 t '' 
