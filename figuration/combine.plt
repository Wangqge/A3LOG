...
plot "arabic_cc.txt" u 1:2 w lp lt 1 pt 2 ps 2 lc 2 lw 5 title columnheader(2), "arabic_cc.txt" u 3:4 w lp lt 1 pt 0 ps 2 lc 0 lw 5 title columnheader(4), "arabic_cc.txt" u 5:6 w lp lt 2 pt 2 ps 2 lc 2 lw 5 title columnheader(6), "arabic_cc.txt" u 9:10 w lp lt 4 pt 4 ps 2 lc 4 lw 5 title columnheader(10), "arabic_cc.txt" u 11:12 w lp lt 5 pt 5 ps 2 lc 5 lw 5 title columnheader(12)
unset yrange
...
plot "arabic_cc_buffer.txt" u 1:2 w lp pt 3 ps 2 lc 3 lw 5 title "async_{dym}", "arabic_cc_buffer.txt" u 3:4 w lp  pt 4 ps 2 lc 4 lw 5 title "async_{pd}", "arabic_cc_buffer.txt" u 5:6 w lp lt 2 pt 1 ps 2 lc 1 lw 5 title "async_{1000}","arabic_cc_buffer.txt" u 7:8 w lp lt 2 pt 5 ps 2 lc 5 lw 5 title "async_{2000}"
unset yrange
...
set format y "10^{%L}"
set xtics rotate by 330
plot "wiki_cc.txt" u 1:2 w lp linetype 1 pt 0 ps 2 lc 0 lw 5 title "sync", "wiki_cc.txt" u 3:4 w lp linetype 1 pt 1 ps 2 lc 2 lw 5 title "async_{2000}", "wiki_cc.txt" u 5:6 w lp lt 2 pt 1 ps 2 lc 1 lw 5 title "async_{1000}", "wiki_cc.txt" u 7:8 w lp lt 3 pt 5 ps 2 lc 5 lw 5 title "async_{block}", "wiki_cc.txt" u 9:10 w lp lt 4 pt 4 ps 2 lc 4 lw 5 title "async_{d}"
unset yrange
...
plot "wiki_cc_buffer.txt" u 1:2 w lp pt 3 ps 2 lc 3 lw 5 title "async_{dym}", "wiki_cc_buffer.txt" u 3:4 w lp  pt 4 ps 2 lc 4 lw 5 title "async_{pd}", "wiki_cc_buffer.txt" u 5:6 w lp lt 2 pt 1 ps 2 lc 1 lw 5 title "async_{1000}","wiki_cc_buffer.txt" u 7:8 w lp lt 2 pt 5 ps 2 lc 5 lw 5 title "async_{2000}"
...
set format y "10^{%L}"
set xtics rotate by 330
plot "arabic_sssp.txt" u 1:2 w lp lt 1 pt 1 ps 1 lc 1 lw 5 title columnheader(2), "arabic_sssp.txt" u 3:4 w lp lt 1 pt 2 ps 2 lc 2 lw 5 title columnheader(4), "arabic_sssp.txt" u 5:6 w lp lt 2 pt 0 ps 2 lc 0 lw 5 title columnheader(6),  "arabic_sssp.txt" u 9:10 w lp lt 4 pt 4 ps 2 lc 4 lw 5 title columnheader(10), "arabic_sssp.txt" u 11:12 w lp lt 5 pt 5 ps 2 lc 5 lw 5 title columnheader(12)
unset logscale
unset format
...
plot "arabic_sssp_buffer.txt" u 1:2 w lp pt 3 ps 2 lc 3 lw 5 title "async_{dym}", "arabic_sssp_buffer.txt" u 3:4 w lp  pt 4 ps 2 lc 4 lw 5 title "async_{pd}", "arabic_sssp_buffer.txt" u 5:6 w lp lt 2 pt 1 ps 2 lc 1 lw 5 title "async_{1000}","arabic_sssp_buffer.txt" u 7:8 w lp lt 2 pt 5 ps 2 lc 5 lw 5 title "async_{2000}"
unset logscale
unset format
...
set format y "10^{%L}"
set xtics rotate by 330
plot "wiki_sssp.txt" u 1:2 w lp linetype 1 pt 0 ps 1 lc 0 lw 5 title columnheader(2), "wiki_sssp.txt" u 3:4 w lp linetype 1 pt 1 ps 2 lc 1 lw 5 title columnheader(4), "wiki_sssp.txt" u 5:6 w lp lt 2 pt 2 ps 2 lc 2 lw 5 title columnheader(6), "wiki_sssp.txt" u 7:8 w lp lt 3 pt 3 ps 2 lc 3 lw 5 title columnheader(8), "wiki_sssp.txt" u 9:10 w lp lt 4 pt 4 ps 2 lc 4 lw 5 title columnheader(10)
unset logscale
unset format
...
plot "wiki_sssp_buffer.txt" u 1:2 w lp pt 4 ps 2 lc 4 lw 5 title columnheader(2), "wiki_sssp_buffer.txt" u 3:4 w lp  pt 3 ps 2 lc 3 lw 5 title columnheader(4), "wiki_sssp_buffer.txt" u 5:6 w lp lt 2 pt 1 ps 2 lc 1 lw 5 title columnheader(6),"wiki_sssp_buffer.txt" u 7:8 w lp lt 2 pt 5 ps 2 lc 5 lw 5 title columnheader(8)
