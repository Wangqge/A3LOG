...
#set yrange [0:1E+15]
set size ratio 0.6
set ylabel "value" font "Time-Roman,40" offset 1
set tics font ",28"
...
set size 1.025,1.025
set origin 0.8,-0.04
#set yrange [0:8000]
set ylabel "buffersize"  font "Time-Roman,40" offset 3
set size ratio 0.6
set tics font ",28"
...
#set yrange [0:1E+15]
set size ratio 0.6
set ylabel "delta"  font "Time-Roman,40" offset 1
set tics font ",28"
...
#set yrange [0:1E+15]
set size ratio 0.6
set ylabel "delta"  font "Times-Roman,40" offset 1
set tics font ",28"
...
set origin 0.8,0.98
#set yrange [0:8000]
set ylabel "buffersize"  font "Times-Roman,40" offset 3
set size ratio 0.6
set tics font ",28"
