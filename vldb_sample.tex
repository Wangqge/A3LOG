...
Qiange Wang$^1$, Liang Geng$^{1,2}$, Yanfeng Zhang$^1$, Rubao Lee$^2$, Xiaodong Zhang$^2$, Ge Yu$^1$\\
      ...
      % \email{\{wangqiange, gengliang\}@stumail.neu.edu.cn, {zhangyf, yuge}@mail.neu.edu.cn, zhang@cse.ohio-state.edu}
...
\end{abstract}
\keywords{Asynchronous parallel aggregation, recursive program, synchronous aggregation, Datalog}
