...
\begin{table}[!t]
	...
	\begin{tabular}{c|c|c|c}
		...
		\hline
		{\textbf{Orkut}} &3072441& 117184899 & \cite{} \\
		\hline
		{\textbf{culeweb09}} & 20000000 & 243,063,334 &\cite{}\\		\hline
...
\Paragraph{CC}  Each vertex starts as its own connected component with its identifier. For all combinations of facts that satisfy the recursive bodies.
On all test graph A3Log outperforms all these three competitors on CC algorithm. The best case of asynchronous processing can consistently beat the synchronous version.

\Paragraph{SSSP} For SSSP algorithm ,A3log outperforms all these three competitors. Asynchronous processing better performance on  

\Paragraph{PageRank} PageRank is a very important graph algorithm.
